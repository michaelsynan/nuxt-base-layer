import { version, getCurrentInstance, inject, ref, watchEffect, watch, useSSRContext, createApp, reactive, unref, isRef, provide, onErrorCaptured, onServerPrefetch, toRef, shallowRef, computed, isReadonly, defineAsyncComponent, nextTick, defineComponent, h, Suspense, Transition } from 'vue';
...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-30f00e7d.mjs').then((m) => m.default || m)
  },
  {
    name: "test",
    path: "/test",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/test-2b10da0e.mjs').then((m) => m.default || m)
  }
];
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/error-component-1707b211.mjs').then((r) => r.default || r));
