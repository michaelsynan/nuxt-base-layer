...
import {
  ...
  require_stream,
  require_util
} from "./chunk-STIIPNWQ.js";
import {
  notNullish,
  slash,
  throttle,
  toArray
} from "./chunk-4NTKCVSL.js";
import "./chunk-4MHY7UII.js";
import {
  __commonJS,
  __publicField,
  __require,
  __toESM
} from "./chunk-K5SQRO6V.js";
...
async function resolveVue22(code, s) {
  ...
  const nodes = [];
  const { walk: walk2 } = await import("./src-EJAVKJEF-GJE5GNRP.js");
  walk2(program, {
    enter(node) {
